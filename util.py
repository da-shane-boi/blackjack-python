...
def create_button(surface, mouse:tuple[int,int], text:str, font,  button_topleft:tuple, button_dimensions:tuple, colour_button_normal:tuple[int,int,int], colour_button_highlighted:tuple[int,int,int], colour_text_normal:tuple[int,int,int], colour_text_highlighted:tuple[int,int,int]):
    ...
    if mouse_over_button(mouse, button_topleft, button_dimensions[0], button_dimensions[1]):
        pg.draw.rect(surface, colour_button_highlighted, [button_topleft[0], button_topleft[1], button_dimensions[0], button_dimensions[1]])
        return font.render(text, True, colour_text_highlighted)
    else:
        pg.draw.rect(surface, colour_button_normal, [button_topleft[0], button_topleft[1], button_dimensions[0], button_dimensions[1]])
